...
define('G5_YOUNGCART_VER', '5.3.3.3');
...
define('G5_TIME_YEAR',       substr(G5_TIME_YMDHIS, 0, 4));
...
// SEO TITLE 문단 길이
define('G5_SEO_TITEL_WORD_CUT', 8);
...
if (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') {   //https 통신일때 daum 주소 js
    define('G5_POSTCODE_JS', '<script src="<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>');
