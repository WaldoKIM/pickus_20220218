...
<div class="sidenav">
    ...
    <ul class="nav" id="nav-left">
        ...
        <?php if (($member['mb_level'] == 2) || ($member['mb_level'] == 10)) : ?>
            ...
            <!-- <li><a class="devtemp" href="http://repickus.com:8090">임시</a></li> -->
        <?php endif; ?>
                    ...
                    <ul>
                        ...
                        ?>
                            ...
                            <?php if ($member['mb_level'] == 2) { ?>
                                ...
                                <li><a class="small_nav" href="/bbs/history_partner.php">정산내역</a></li>
                            <?php } ?>
                            <?php if ($member['mb_level'] == 8) { ?>
                ...
                <li class="td this_gnb">
                    ...
                    <div class="gnb_menu">
                        <ul style="display: flex;flex-direction: row;flex-wrap: nowrap;"class="myMenu">
                            ...
                            <?php endif; ?>
                            <?php if ($member['mb_level'] == 2 || $member['mb_level'] == 10) : ?>
                                <li><a class="btn" href="/estimate/estimate_list2.php"><span class="tx">견적리스트</span></a>
                                    <ul class="submenu">
                                    <li><a href="/estimate/estimate_list2.php" class="">매입/철거</a></li>
                                    <li><a href="/estimate/estimate_list3.php" class="">판매매칭</a></li>
                                    <li><a href="/estimate/estimate_list1.php" class="">맞춤견적</a></li>
                                </ul>
                                </li>
                                <li><a class="btn" href="/estimate/partner_estimate_list.php"><span class="tx">내 견적현황</span></a>
                                    <ul class="submenu">
                                    <li><a href="/estimate/partner_estimate_list.php" class="">매입/철거</a></li>
                                    <li><a href="/estimate/partner_estimate_list.php?gubun=6" class="">구매</a></li>
                                    </ul>
                                </li>
                                <li><a class="btn" href="../market/seller/order/trade.php"><span class="tx">판매자센터</span></a></li>
                            <?php endif; ?>
                            <?php if ($member['mb_level'] != 2) : ?>
                            ...
                            <?php if (($member['mb_level'] == 2) || ($member['mb_level'] == 10)) : ?>
                                ...
                                <!-- <li class="devtemps"><a class="devtemp" href="http://repickus.com:8090">임시</a></li>-->
                            <?php endif; ?>
                            <!-- <?php if ($member['mb_level'] != 2) : ?>
