...
<div class="sub-page" style="max-width: 1200px; margin:0 auto">
		 	...
		 	<div class="boxy-warp">
				...
				<style>
					#container_k {
					 ...
					 border-radius: 5px;
					display:flex; width:100%; flex-direction: row; flex-wrap: wrap; align-content: flex-start;
					...
					.col_k { width: 23.5%;margin:0;margin-right:2%;margin-bottom:5%;position:relative;}
					.col_k:nth-child(4n){margin-right:0;}
					.gall_chk{position:absolute;top:0px;left:5px;}
					
					@media screen and (max-width:1000px) {
						.col_k { width: 32%;margin-right:2%;}
						.col_k:nth-child(4n){margin-right:2%;}
						.col_k:nth-child(3n){margin-right:0;}
					}
					@media screen and (max-width:700px) {
						.col_k { width: 49%;margin-right:2%;}
						.col_k:nth-child(3n){margin-right:2%;}
						.col_k:nth-child(2n){margin-right:0;}
					}
				...
				<div id="bo_gall" style="width:<?php echo $width; ?>">
					...
					<?php } ?>
					 <!-- 게시판 검색 시작 { -->
					<fieldset id="bo_sch" style="margin-top:30px;">
						...
						<?php for ($i=0; $i<count($list); $i++) {
						 ...
						 ?>
							...
							<div class="box_k col_k">
								...
								<input type="checkbox" name="chk_wr_id[]" value="<?php echo $list[$i]['wr_id'] ?>" id="chk_wr_id_<?php echo $i ?>" style="margin:0;">
								<?php } ?>
								...
								<div class="gall_con">
									...
									<div class="gall_text_href">
										...
										<?php } ?>
										<a href="<?php echo $list[$i]['href'] ?>" class="bo_tit" style="font-size:16px;font-weight:400;">
