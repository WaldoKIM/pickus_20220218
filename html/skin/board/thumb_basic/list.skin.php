...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
		...
		?>
            ...
            <td class="td_subject" style="<?php if ($list[$i]['icon_reply']) { ?>border-top:1px; <?php } ?>padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px;" <?php if ($list[$i]['icon_reply']) { ?>colspan="2"<?php } ?>>
                ...
                <div class="bo_tit">
                    ...
                    <?php if (!$list[$i]['icon_reply']) { ?>
                        ...
                        <?php if($img_content) { ?>
                        <div class="img_v_mo mo_view" style="background-image:url(<?php echo $img_content; ?>);" onclick="location.href='<?php echo $list[$i]['href'] ?>';"></div>
                        <?php } ?>
                    <?php } else { ?>
                        <?php if($list[$i]['icon_secret']) { ?><i class="fa fa-lock fa-lock2" aria-hidden="true"></i> <?php } ?> <a href="<?php echo $list[$i]['href'] ?>" class="sub_j sub_j_re">
                        <?php echo $list[$i]['subject'] ?> <?php if ($list[$i]['wr_comment']) { ?><span class="re_cmt">+<?php echo $list[$i]['wr_comment']; ?></span><?php } ?>
                    ...
                    <ul class="bo_tit_ul4" style="<?php if ($list[$i]['icon_reply']) { ?>padding-left:21px;<?php } ?>">
                        <span class="bo_names"><?php echo $list[$i]['name'] ?></span>　
            ...
            <?php if (!$list[$i]['icon_reply']) { ?>
            <td class="td_datetime" style="<?php if ($list[$i]['icon_reply']) { ?>border-top:1px; <?php } ?>">
                <?php if($img_content) { ?>
                    <div class="img_v_pc pc_view" style="background-image:url(<?php echo $img_content; ?>);" onclick="location.href='<?php echo $list[$i]['href'] ?>';"></div>
                <?php } ?>
            </td>
            ...
            <?php if ($is_checkbox) { ?>
            <td class="td_chk chk_box" style="<?php if ($list[$i]['icon_reply']) { ?>border-top:1px; <?php } ?>">
