...
<div class="sub-page">
	...
	<div class="news-notice-warp">
		 <div class="boxy-warp"> 
			<h1 class="sub-title wow slideInUp"  data-wow-duration="1s" data-wow-delay="0s">NEWS & NOTICE</h1>
		 </div>
		 <!-- s: brand-news -->
		 <div class="brand-news">
		 	<div class="boxy-warp">
				...
				<style>
					...
					.col_k { width: 23.5%;margin:0;margin-right:2%;margin-bottom:2%;position:relative;}
