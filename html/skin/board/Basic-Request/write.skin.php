...
<style type="text/css">
	h2.tit_wr{font-size: 24px; text-align: center; margin-bottom: 25px;}
	table.tb_navi{margin: 0 auto;border: 3px solid #1379cd; border-radius: 10px; padding: 15px; display: inline-block; float: left; width: 70%;}
	table.tb_navi td{padding: 5px 10px; font-size: 16px;}
	table.tb_navi td input[type="text"], table.tb_navi td select{border: 1px solid #ccc; padding: 0 10px; color: #000; font-size: 1}
	div.tb_right{display: inline-block; border: 3px solid #1379cd; border-radius: 10px; margin-left: 3%; width: 27%; padding: 15px;}
	div.tb_right h3{font-size: 20px; text-align: center;}
	div.tb_right p{margin-top: 20px; text-align: center; margin-bottom: 5px;}
	div.tb_right #btn_send1{margin-top: 0;}
	...
	.get_goods{border-bottom:2px solid #1379cd; padding: 5px; font-size: 14px; color: #000;}
	input#no_log{float: right; width: 20px;}
	...
	.get_goods input[type="number"]:nth-of-type(n+2){display: none;}
	textarea{width: 100%;}
	input#btn_send2,input#btn_send3{font-size: 20px; width: 100%; height: 50px;}
	#section3 input[type="checkbox"]{margin-top: -2px;}
</style>
<div id="section1">
	<h2 class="tit_wr">물품구매정보</h2>
	...
	<table class="tb_navi">
		<tr>
			<td>제목</td>
			<td><input type="text" name="tit_req" id="tit_req"></td>
		</tr>
		<tr>
			<td>장소</td>
			<td>
		...
		<tr>
			<td>구매품목리스트</td>
			<td>
				<label for="test_select1">가전</label>
				<input type="radio" name="test_text1" value="가전" id="test_select1">
				<label for="test_select2">주방집기</label>
				<input type="radio" name="test_text1" value="주방집기" id="test_select2">
				<label for="test_select3">헬스용품</label>
				<input type="radio" name="test_text1" value="헬스용품" id="test_select3">
				<label for="test_select4">가구</label>
				<input type="radio" name="test_text1" value="가구" id="test_select4">
			</td>
		</tr>
		<tr>
			<td></td>
...
<div id="section3" style="display: none;">
	...
	<table class="tb_info">
		...
		<tr>
			<td colspan="2" style="text-align: center;">서비스 이용약관 및 개인정보 취급방취 동의합니다. <input required="" type="checkbox" name=""> </td>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    ...
	    function log( message ) {
	      $( "<div class='get_goods'>" ).text( message ).prependTo( "#log" );
	      $( "<input type='number' value='1' min='1' name='no_log' id='no_log' />" + "개" ).text( message ).appendTo( ".get_goods" );
...
<!-- 게시물 작성/수정 시작 { -->
<form name="fwrite" style="display: none;" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" role="form" class="form-horizontal">
	...
	<div class="panel-body" style="padding-bottom:0px;">
		<div class="form-group">
			<table class="tb_info">
				...
				<tr>
					<th>비용</th>
					<td colspan="5"><input type="text" name="as_view" value="<?php echo ($write['as_view']) ? $write['as_view'] : 0; ?>" id="as_view" class="form-control input-sm" size="10" maxlength="10" placeholder="숫자만 가능" numeric>
					<span class="input-group-addon">만원</span>(0 입력시 '협의'라고 표시됨)</td>
				</tr>
				<?php if ($is_category) { ?>
				<tr>
					<th>분류<strong class="sound_only">필수</strong></th>
					<td colspan="5">
				...
				<tr>
					<th>이름</th>
					<td><input type="text" name="wr_1" id="wr_1" value="<?php echo $view['wr_1']?>"></td>
					<th>이메일</th>
					<td><input type="text" name="wr_2" id="wr_2" value="<?php echo $view['wr_2']?>"></td>
					<th>휴대폰</th>
					<td><input type="text" name="wr_3" id="wr_3" value="<?php echo $view['wr_3']?>"></td>
				</tr>
				<tr>
					<th>제목</th>
					<td colspan="5">
						...
						<span class="input-group-btn">
							...
							<?php if ($is_member) { // 임시 저장된 글 기능 ?>
								<button type="button" id="btn_autosave" data-toggle="modal" data-target="#autosaveModal" class="btn btn-black btn-sm">임시 저장글 (<span id="autosave_count"><?php echo $autosave_count; ?></span>)</button>
							<?php } ?>
						</span>
					</td>
				</tr>
...
<script type="text/javascript">
	$(document).ready(function(){
		window.open('http://103.55.191.125/test.php', 'window', 'width=600, height=400');
	});
</script> -->
