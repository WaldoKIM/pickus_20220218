...
<div class="view-comment font-18 en">
	총 <span class="orangered"> <?php echo number_format($write['wr_comment']);?></span>개의 지원서가 있습니다.
</div>
		 ...
		 ?>
			<div class="media" id="c_<?php echo $comment_id ?>"<?php echo ($cmt_depth) ? ' style="margin-left:'.$cmt_depth.'px;"' : ''; ?>>
				...
				<div class="media-body">
					...
					<p>여분필드1 : <?php echo $list[$i]['wr_1']; ?><br>여분필드2 : <?php echo $list[$i]['wr_2']; ?><br>여분필드3 : <?php echo $list[$i]['wr_3']; ?></p>
					<button class="btn_pick">업체 선정</button>
					<button class="btn_see">지원서 확인</button>
			  </div>
			</div>
