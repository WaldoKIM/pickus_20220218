...
<style type="text/css">
	...
	#fboardlist{max-width: 900px; border-top: 1px solid #000; margin: 0 auto;}
	.list-page{padding-bottom: 15px;}
	.list-page a{height: 40px;}
</style>
...
<div class="sub_title">
	...
	<?php } ?>
	<?php if($_GET['bo_table'] == 'notice_partner'){ ?>
	<h1 class="main_co">업체 공지사항</h1>
	<?php } ?>
	...
	<div class="list-wrap">
		<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
			...
			<div class="list-btn-box">
				...
				<?php } ?>
				<?php if($is_member){ ?>
					<a href="/bbs/write.php?bo_table=<?php echo $_GET['bo_table'] ?>" class="btn btn-color btn-sm"><i class="fa fa-pencil"></i><span>글쓰기</span>
				</a>
				<?php } ?>
