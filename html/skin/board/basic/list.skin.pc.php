...
<style type="text/css">
	...
	table.list-pc th{background: #fff !important;font-weight: 400; border-bottom: 1px solid #ccc !important;}
	table.list-pc tbody tr td:nth-of-type(3){text-align: center;}
</style>
<div class="table-responsive">
	<table class="table div-table list-pc bg-white">
	<thead>
	<tr>
		<th style="width:25%;" scope="col">번호</th>
		...
		<th scope="col" style="width:25%;"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>작성일</a></th>
		<th scope="col" style="width:25%;"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?><nobr>조회수</nobr></a></th>
		<?php if($is_good) { ?>
	...
	<tr<?php echo $tr_css; ?>>
		...
		<td class="text-center en font-11"><?php echo apms_date($list[$i]['date'], '', 'H:i', 'm.d', 'Y.m.d'); ?></td>
