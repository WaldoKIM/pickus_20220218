...
<style type="text/css">
	.well{display: none;}
	.form-horizontal .control-label{background-color: transparent; padding-bottom: 0; color: #333; font-size: 16px; text-align: left;}
	#fwrite{max-width: 900px; margin: 0 auto; background-color: #fff; padding: 30px; margin-bottom: 60px; border:1px solid #ededed;}
	.input-group-btn{display: none;}
	input[type="text"], input[type="password"], input[type="search"], input[type="email"], input[type="number"], input[type="tel"]:focus{background-color: #fff; width: 100%;}
	.sub_title{margin-bottom: 70px;}

	.form-horizontal .has-feedback .form-control-feedback{display: none;}
	button.btn.btn-color.btn-sm,
	.btn.btn-color:hover b, .btn.btn-color:focus b, .btn.btn-color:active b{color: #000;}
</style>
