...
<section style="display: none" id="anc_sitfrm_compact">
		...
		<tr style="display: none;">
			...
			<td>
				...
				<select name="it_notax" id="it_notax">
					...
					<option selected value="1"<?php echo get_selected('1', $it['it_notax']); ?>>비과세</option>
				</select>
			</td>
		</tr>
		<?php 
...
<section style="display: none;" id="anc_sitfrm_sendcost">
...
<section style="display: none;" id="anc_sitfrm_relation" class="srel anc-section">
...
<section style="display: none;" id="anc_sitfrm_opt" class="anc-section">
...
<section style="display: none;" id="anc_sitfrm_attach" class="anc-section">
