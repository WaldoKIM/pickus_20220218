...
include_once($g5_path['path'].'/lib/fb.php');
...
ini_set("session.cache_expire", 18000000); // 세션 캐쉬 보관시간 (분)
//ini_set("session.gc_maxlifetime", 10800); // session data의 garbage collection 존재 기간을 지정 (초)
ini_set("session.gc_maxlifetime", 244000); // session data의 garbage collection 존재 기간을 지정 (초)
