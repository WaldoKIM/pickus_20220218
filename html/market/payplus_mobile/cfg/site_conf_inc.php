...
if($pginfo->pg_true==1){
	$urlSeting = "paygw.kcp.co.kr";
	$jsSeting = "https://pay.kcp.co.kr/plugin/payplus.js";
	$modulSeting = "real_KCPPaymentService.wsdl";
}else{
	$urlSeting = "testpaygw.kcp.co.kr";
	$jsSeting = "https://pay.kcp.co.kr/plugin/payplus_test.js";
	$modulSeting = "KCPPaymentService.wsdl";
}
    /* ============================================================================== */
    ...
    /* ============================================================================== */
    $g_conf_home_dir  = $ROOT_DIR."/payplus";       // BIN 절대경로 입력 (bin전까지) 
    ...
    /* ============================================================================== */
	if($pginfo->pg_true=="1"){
		$g_conf_site_cd   = $pginfo->pg_code;
		$g_conf_site_key  = $pginfo->pg_key;
	}else{
