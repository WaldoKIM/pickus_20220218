													...
													<table border="0" width="100%">
																...
																<div class="customertable_divcenter_1">
																	<table width="100%" class="table_all table_all_moA">
																		<tr bgColor="white"> 
																			...
																			<td class='tabletd_all tabletd_Lmall'><? if($trade_stat->trade_stat==1) {?>결제대기중<?} else if($trade_stat->trade_stat==2){?>결제확인됨<?} else if($trade_stat->trade_stat==3){?>배송중<?} else if($trade_stat->trade_stat==4){?>판매완료됨<?}?></td>
																		</tr>
																	</table>
																</div>
															</div>
														...
														<table width="100%" class="table_all">
															<tr align="center"  bgcolor="E4E7EF" class='contenM tabletd_all'> 
																...
																<?/*
																<td height="35" class='contenM tabletd_all noneoolimmoL'>배송</td>
																*/?>
															</tr>
															<?
