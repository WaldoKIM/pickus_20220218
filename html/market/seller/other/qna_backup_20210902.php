										...
										<td height="150" align="center" valign="top" bgcolor="#FFFFFF" class="menu">
											<table width="100%">
												<tr>
													<td height="25">
														<table>
															<tr>
																<td class="sub_titleM"><a name="teb01"></a>
																		...
																		<tr>
																			<td bgcolor="#E9F2F8">
																				<table width="100%">
																					...
																					<tr>
																						<td class='sensbody'>1. 질문글에 대한 답변글을 작성 하신 후에는 반드시 상태 변경(답변완료) 체크를 해주시기 바랍니다.</td>
																					</tr>
																				</table>
																			</td>
																		</tr>
											...
											<table width="100%" class="table_all">
												<tr height='40'>
													...
													<td bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all'>상태</td>
													...
													<td bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all'>작성일</td>
												</tr>
												<?
												$listScale			=	15; 		// 리스트갯수
												$pageScale		=	15;		// 페이지 갯수
												...
												?>
													<form name="form_<?= $form_name ?>" method="post" action="<?= $_SERVER[PHP_SELF]; ?>?review_data=<?= $review_data; ?>">
														...
														<tr bgColor="white" align="center" height="25">
															...
															<td class='tabletd_all tabletd_Lmall revbox_none'><a href="http://<?= $admin_stat->shop_url ?>/product_view.php?goods_data=<?= $goods_data; ?>" target="_NEW">
																	<font color='909090'><?= $goods_stat->name; ?></font>
																</a></td>

															<td class='tabletd_all tabletd_Lmall' style='text-align:left;'><?= $row->title; ?><a href="javascript:reviewView('<?= $review_data; ?>');" class="menusmall_btn3">답글달기</a><br><span class='request_noneoolim'>
																	<font color='909090'><?= $goods_stat->name; ?></font>
																</span></td>

															<td class='tabletd_all tabletd_Lmall revbox_none'><a href="javascript:userSendmailWinOpen('<?= $member_stat->email; ?>');">
																	<font color='7AA9E9'><?= $row->userid; ?></font>
																</a></td>

															<td class='tabletd_all tabletd_Lmall'>
																<span class='revbox_on' style='text-align:center;'>
																	<font color='7AA9E9'><?= $row->userid; ?></font>
																</span>
