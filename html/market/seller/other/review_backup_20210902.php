				...
				<td class="padding_5">
					<table width="100%">
																	...
																	<table width="100%" class='tipbox noneoolim'>
																		<tr>
																			<td bgcolor="#E9F2F8">
																				<table width="100%">
																					<tr>
																						<td class='sensbody'>1. 상품에 대한 후기를 확인하고 답글을 작성할 수 있습니다.</td>
																					</tr>
																				</table>
																			</td>
																		</tr>
						...
						*/ ?>
																...
																<? } ?>
																<?= $row->title; ?><a href="javascript:reviewView('<?= $review_data; ?>');" class="menusmall_btn3" style='margin:3px;'>답글달기</a><br><span class='request_noneoolim'><a href="http://<?= $admin_stat->shop_url ?>/product_view.php?goods_data=<?= $goods_data; ?>" target="_NEW">
																		<font color='909090'><?= $goods_stat->name; ?></font>
																	</a></span>
															</td>
