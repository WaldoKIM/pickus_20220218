						...
						<tr>
																		...
																		<tr>
																			<td bgcolor="#E9F2F8">
																				<table width="100%">
																					...
																					<tr>
																						<td>
																							<font color="red">메인위치 우선순위</font>는 메인에 이벤트상품 위치 및 주메뉴 카테고리에 스페셜상품코너에 반영됩니다.
																						</td>
																					</tr>
																					<tr>
																						<td>
																							<font color="red">서브위치</font>는 해당 상품 카테고리 내에서 신상품, 베스트상품으로 노출됩니다.
																						</td>
																					</tr>
																				</table>
																			</td>
																...
																<div id="customertable_divLeft_view">
																	<div class="customertable_divLeft">
																		<table width="100%" class="table_all">
																			<tr>
																				<td height="35" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all'>카테고리별 검색</td>
																			</tr>
																			<tr>
																...
																<div id="customertable_divcenter_1_view">
																	<div class="customertable_divcenter_1">
																		<table width="100%" class="table_all table_all_moA">
																			<tr>
																				<td height="35" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all'>키워드 검색</td>
																			</tr>
																			<tr>
																				<td style='padding:5px;'>
																					<!--도움말-->
																						...
																						<tr>
																							<td bgcolor="#E9F2F8">
																								<table width="100%">
																									...
																									<tr>
																										<td class='sensbody'>카테고리 검색이후 해당 카테고리 내에서 키워드 검색을 이용을 하시려면 <br>
																											<font color="red">카테고리내 검색</font>을 선택하신 검색을 이용하시기 바랍니다.<br>
																											카테고리내 검색을 이용하지 않을 경우에는 전체 상품를 기준으로 검색됩니다.<br>
																											<font color="red">중지상품 검색</font>은 중지된 상품내에서만 검색됩니다.
																										</td>
																									</tr>
																								</table>
																							</td>
							...
							<? if ($newPart == 1) { ?>
								<table width="100%" class="table_all" border=1>
									...
									<tr>
										<td height="25" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all noneoolimmoL'>NO</td>
										<td height="25" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all'>사진</td>
										<td height="25" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all noneoolimmoL'>판매설정</td>
										<td height="25" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all noneoolimmoL'>상품명</td>
										<td height="25" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all noneoolim'>금액</td>
										<?/*
													<td height="25" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all'>메인/서브위치</td>
													*/ ?>
										<td height="25" bgcolor="#178cdb" style="color:#fff;" class='contenM tabletd_all'>관리</td>
									</tr>
								<? } ?>
