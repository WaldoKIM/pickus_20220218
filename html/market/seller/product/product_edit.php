									...
									<tr> 
										<td style="display: block !important; float: none !important;" height="75" align="center" valign="top" bgcolor="#FFFFFF" class="border_shadow menu"><br> 
											<table width="100%" style="border:none !important" class="table_all" id="product_info" name="product_info">
												<tr bgcolor="white"> 
													<td style="display:none;" bgcolor="E4E7EF" height="25"  align="center" class='contenM tabletd_all'>카테고리</td>
													<td class="product_list_category_font"><?=$part_name;?> </td>
												</tr>
												<tr style="display:none;" bgColor="white"> 
													<td style="display:none;" bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>진열대 출력</td>
													<td class='tabletd_all tabletd_small'>진열대출력<input name="display" type="radio" value="1" <? if( $row->display == 1) { echo("checked");}?>>예&nbsp;<input name="display" type="radio" value="0" <? if( $row->display == 0 ) { echo("checked");}?>>아니오&nbsp;&nbsp;(상품 전시 판매 유무 설정합니다.)</td>
												</tr>	
												<tr style="display:none;" bgColor="white"> 
													<td style="display:none;" bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>상품코드</td>
													<td class='tabletd_all tabletd_small'>상품코드<input name="code" type="text" maxlength="20" size="20" class="formText" value="<?=$row->code;?>" <?=$style->colorAlign("#666666 ", 0);?> readOnly>&nbsp;(상품 코드는 수정 불가능합니다.)</td>
												</tr>
												...
												*/?>
												...
												<tr bgColor="white"> 
													<td style="display:none;" bgcolor="E4E7EF" height="65" align="center" class='contenM tabletd_all'>상품이미지</td>
													<td height="40" colspan="2"  class='tabletd_all tabletd_small td_design input_font'>
														<table width="100%">
															<tr> 
																<td>
																	<table width="100%">
																				...
																				<div id="itemtable_itemcont">
																					<div id="itemtable_itemCenter">
																						<div class="itemtable_itemCenter sensbody input_font">
																							<p class="product_font" style="padding-left:10px;">대표이미지<? if( $row->images1) { ?><a style="display:none; background:#ddd; color:#333;" href="../../data/goodsImages/<?=$row->images1;?>" rel="lightbox" class='btn_guide1'>미리보기</a><? }?></p>
																							<label for="input-file0"><img src="../../data/goodsImages/<?=$row->images1;?>" id="img_section0"></label>
																							<input style="display:none;" id="input-file0"name="images1" type="file"  class="file_text_mo2 input_font">
																							<?for($i=1;$i<=5;$i++){?>
																								
																									<div style="display:none;" id="itemtable_itemLeft">
																										...
																										<? if( $row->{"add_images".$i}) { ?>
																											<img src="../../data/goodsImages/<?=$row->{"add_images".$i};?>" id="img_section<?=$i?>">
																										<? } else { ?>
																											<img src="/img/common/estimate_icon_image_info.png" id="img_section<?=$i?>">
																										<? } ?>
																										</label>
																										<input style="display:none;" id="input-file<?=$i?>" name="add_images<?=$i?>" type="file"  class="file_text_mo2">
												...
												<tr bgColor="white"> 
													<td style="display:none;" bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>상품명</td>
													<td height="25" class='tabletd_all tabletd_small td_design input_font'>
														<p class="product_font" style="padding-left:10px;">상품명</p>
														<input style="border-bottom: 1px solid #ddd !important;" placeholder="상품명"name="name" type="text" class="border_none formText input_font input_design product_font" value="<?=$db->stripSlash($row->name);?>">
													</td>
												</tr>
												
												<tr id="md_form" bgColor="white"> 
													
													<td style="line-height: 0.5 !important;" class='tabletd_all tabletd_small td_design input_font'>
														<p class="product_font" style="padding-left:10px;">모델명</p>
														<input style="border-bottom: 1px solid #ddd !important; " placeholder="모델명 : 예) ABC-1234" id="model_name" name="model_name" type="text" class="border_none formText input_font input_design product_font" value="<?=$row->model_name;?>">
													</td>
												</tr>	
												<tr bgColor="white"> 
													<td style="display:none;" bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>판매가격</td>
													<td height="25" class='tabletd_all tabletd_small td_design input_font'>
														<p class="product_font" style="padding-left:10px;">판매가격</p>
														<input style="border-bottom: 1px solid #ddd !important;" class="border_none formText input_font input_design product_font" name="shop_price" type="number" placeholder="판매가격" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?> value="<?=$row->shop_price;?>">
													</td>
												</tr>
												<tr style="display:none;" bgColor="white"> 
													<td style="display:none;" width="20%" height="25" bgcolor="E4E7EF"  align="center" class='contenM tabletd_all'>배송비</td>
													<td class='tabletd_all tabletd_small td_design input_font' colspan="2">
														<p class="product_font" style="padding-left:10px;">배송비</p>
														<input name="deliv_fee" type="text" class="formText input_font input_design product_font" style="border-bottom: 1px solid #ddd !important;" placeholder="배송비(미 입력시 무료배송)" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?> value="<?=$row->deliv_fee;?>" >
													</td>
												</tr>
												<tr style="display:none;" bgColor="white"> 
													<td bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>추가이미지</td>
													<td height="25" colspan="2"  class='tabletd_all tabletd_small'><input type="checkbox" name="add_images_check" value="1" onClick="addImagesCheck();" checked="on"> 추가이미지 입력보기 ( 예 : 전/후/측면/내부/외부....)</td>
												...
												<tr bgColor="white"> 
													<td style="display:none;" bgcolor="E4E7EF" width="20%" height="25" align="center" class='contenM tabletd_all'>상품설명</td>
													<td class='sensO tabletd_all td_design input_font'>
																<p class="product_font" style="padding-left:10px;">상품설명</p>
																	<textarea id="content" name="content" class="product_add_con"><?=$row->content?></textarea>
																	<!-- 에디터를 화면에 출력합니다. -->
									...
									<tr> 
										<td align="center" valign="top" bgcolor="#FFFFFF" class="menu"><br> 
											...
											<table style='margin:0 auto;'>
												<tr>
													<td height='70'><a href="javascript:sendit();" class='product_fix_btn oolimbtn-botton1'>수정하기</a></td>
												</tr>
											</table>
											<table style='margin:0 auto;'>
												<tr>
