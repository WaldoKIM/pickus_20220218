												...
												<table>
													<tr>
														...
														<td style='padding-left:3px;'>
															...
															document.write("<a href='"+content+"' target='_new'><img src='../data/designImages/<?=$iconinfo->icon?>' border='0' alt='<?=$snsrow->name?>' style='vertical-align:top;'></a>")
															document.write("</td>");
															</script>
														</td>
														<?}}}?>
					...
					<td id="fontSzArea2">
						...
						<tr>
							<td height='40'>
								<table width="100%">
									<tr>
										<td align="left" height='40' style='background-color: rgba(0,0,0,0.03);padding:0 1em;'><span class='bbs1'><?=$co_name;?>&nbsp;&nbsp; · &nbsp;&nbsp;<font color='FF8282'><?=$co_reg_date;?></font></span>&nbsp;&nbsp; · &nbsp;&nbsp;<a href="?boardT=pd&T2=c&coment_idx=<?=$co_idx;?>&board_data=<?=$MV_DATA;?>&search_items=<?=$MV_SEARCH_ITEM;?>" class="searchWi">삭제</a></td>
									</tr>
									<tr>
										...
										<tr>
											<td width='100%' align='center' bgcolor='ffffff'>
												<table width='100%'>
													...
													<?if($COMENTSIGN==1){?>
													<tr>
														<td align='center' style="padding-top:5px;"><img src="../chsignup.php?<?=SID?>" align="absmiddle"><input type="text" class="formText" maxlength="15" name="imagecode"  placeholder='*좌측 보안문자 입력'></td>
													</tr>
													<?}?>
												</table>
												<table>
