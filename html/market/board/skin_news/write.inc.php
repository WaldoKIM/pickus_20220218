...
function add_file() {
	...
	if( add_cnt < 5 ) { 
		add_cnt++;
		target = "add_view"+add_cnt;
		document.all[target][0].style.display=""; 
		document.all[target][1].style.display=""; 
	} else { 
					...
					<td valign="top">
						<table width="100%" style='border-collapse: collapse'>
							...
							<tr> 
								...
								<td height="45" style="padding-left:3px" align="left" class='email'><input type="text" name="subject" class="formText email" maxlength="50"></td>
							</tr>
							<tr>
								<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
							</tr>	
							...
							<tr> 
								...
								<td height="45" style="padding-left:3px" align="left"><input type="file" class='file_text' maxlength="15" name="bbs_file">&nbsp;※리스트에 노출되는 이미지(반드시 등록 바랍니다.)</td>
							</tr>
							<tr>
								<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
							</tr>
							<?for($i=1;$i<=5;$i++){?>
							<tr name="add_view<?=$i?>" id="add_view<?=$i?>" style="display:none;"> 
								<td height="65" align="center" bgcolor="#F2F2F2" class='oolimmobilemenuM'>추가파일<?=$i?></td>
								<td height="45" style="padding-left:3px" align="left"><input type="file" class='file_text' maxlength="15" name="add_file<?=$i?>"></td>
							</tr>
							<tr name="add_view<?=$i?>" id="add_view<?=$i?>" style="display:none;">
								<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
							</tr>
							<?}?>
							<tr> 
								<td height="65" align="center" bgcolor="#F2F2F2" class='oolimmobilemenuM'>파일추가</td>
								<td height="45" style="padding-left:3px" align="left"><a href="javascript:add_file();" class="smallBtn07" style="width:60px">파일추가</a> 파일추가는 5개까지 가능합니다.</td>
							</tr>
							<tr>
								<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
							</tr>
								...
								<td colspan="2">
									<table width="100%">
										<tr>
											...
											<td height="45" align="left"><img src="../chsignup.php?<?=SID?>" align="absmiddle">&nbsp;<input type="text" class="formText" maxlength="15" name="imagecode"><br>&nbsp;위 보안용 숫자를 내용을 입력하여 주세요.</td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								<td width="7" colspan="2" height="1" bgColor='#333333'></td>
							</tr>
							<?}?>
						</table>
