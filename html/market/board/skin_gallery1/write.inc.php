							...
							<td valign="top">
								<table width="100%" style='border-collapse: collapse'>
									...
									<tr> 
										...
										<td height="45" style="padding:5px" align="left"><input type="file" class='file_text' maxlength="15" name="bbs_file">&nbsp;※리스트에 노출되는 이미지(반드시 등록 바랍니다.)</td>
									</tr>
									<tr>
										<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
									</tr>
									...
									<tr name="add_view<?=$i?>" id="add_view<?=$i?>" style="display:none;"> 
										...
										<td height="45" style="padding:5px" align="left"><input type="file" class='file_text' maxlength="15" name="add_file<?=$i?>"></td>
									</tr>
									<tr name="add_view<?=$i?>" id="add_view<?=$i?>" style="display:none;">
										<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
									</tr>
									...
									<tr> 
										...
										<td height="45" style="padding:5px" align="left"><a href="javascript:add_file();" class="smallBtn07" style="width:60px">파일추가</a> 파일추가는 5개까지 가능합니다.</td>
									</tr>
									<tr>
										<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
									</tr>
