...
<input type="hidden" name="board_data" value="<?=$MV_DATA;?>">
		<table width="100%" bgColor="#CDCDCD" class="menu" border="0" align="center">
			...
			<tr bgColor="white">
				...
				<td height="45" style="padding-left:3px" align="left" class='email'><input type="file" name="bbs_file" ><?if($review->bbs_file != "none"){?>&nbsp;<input type="checkbox" value="1" name="del_bbs_file">삭제시 선택하여주세요[삭제우선]!<?}?></td>
			</tr>
			<tr>
				<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
			</tr>
					...
					<div id="comment">
						<fieldset>
							<table>
								...
								<tbody>
									<tr>
										<td><div class="box"><textarea name="content"><?=$review->content?></textarea></div></td>
									</tr>
								</tbody>
							</table>
						</fieldset>
