	...
	<div class="joinInfo">
		<div class="bbs_write01">
			...
			<input type="hidden" name="goods_idx" value="<?=$_GET[goods_idx]?>">
				<tr>
					<td align="center">
					<table width="100%" bgColor="#CDCDCD" class="review_write_table menu" border="0" align="center">
						...
						<tr bgColor="white">
							...
							<td height="45" style="padding-left:3px     padding-left: 3px;display: flex;align-items: center;flex-direction: row;flex-wrap: nowrap;" align="left" class='email file_design'><input type="checkbox" name="hold" value="1" class='bbs_input'><img src="images/key_icon2.gif" border="0"><input type="file" name="bbs_file" ></td>
						</tr>
						
						<tr bgColor="white">
							<td style="display:none;" width='20%' align="center" bgcolor="#F2F2F2" class='oolimmobilemenuM'>제 목</td>
							<td style="padding-left:3px" align="left" class='email'><input type="text" name="title" class="formText formText_subject" placeholder="제목을 입력해주세요."></td>
						</tr>
								...
								<div id="comment">
									<fieldset>
										<table>
											...
											<tbody>
												<tr>
													<td style="width: 100%;" ><div class="box"><textarea name="content" placeholder="리뷰 내용을 작성해주세요."></textarea></div></td>
												</tr>
											</tbody>
										</table>
									</fieldset>
