...
<table style='width:100%'>
	<tr class='bar_button_review'>
		...
		?>
	<tr bgcolor='#ffffff' style='border-bottom: 1px solid rgba(0,0,0,0.1);'>
		...
		<a href="<?if($review_row->hold==1 && $review_row->userid!=$_SESSION[USERID]){?>javascript:alert('권한이 없습니다.')<?}else{?>product_review_view.php?board_data=<?=$bbs_data;?><?}?>"><?=$review_row->title;?></a>&nbsp;&nbsp;<?for($i=1;$i<=$review_row->star;$i++){?><i class='fa-star_rev fa-star'></i><?}?>
		</td>
		<td height="35"  align="center" class="oolimitembbs">
		<?
		//작성자 이름 숨김 사용안함
