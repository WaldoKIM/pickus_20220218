					...
					<div class="main">
						<h2 class="tit">구매 후기 보기</h2>
								...
								<table width="100%">
									...
									<?}?>
									<tr>
										<td width='20%' height="65" align="center" bgcolor="#f8f8f8" class='oolimmobilemenuM'>이름</td>
										<td height="45" style="padding-left:3px" align="left" class='oolimitembbs'><?=$review->name?></td>
									</tr>
									<tr>
										<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
									</tr>
									<tr>
										<td width='20%' height="65" align="center" bgcolor="#f8f8f8" class='oolimmobilemenuM'>제목</td>
										<td height="45" style="padding-left:3px" align="left" class='oolimitembbs'><span style='color:#333;font-size:12pt;'><?=$review->title?></span></td>
									</tr>
									<tr>
										<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
									</tr>
									<tr>
										<td width='20%' height="65" align="center" bgcolor="#f8f8f8" class='oolimmobilemenuM'>평가</td>
									...
									<tr>
										<td width='20%' height="65" align="center" bgcolor="#f8f8f8" class='oolimmobilemenuM'>구매평가</td>
										<td height="45" style="padding:2em" align="left" class='oolimitembbs'><?=$review->content?></td>
									</tr>
									<tr>
										<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
									</tr>
									...
									<tr>
										<td width='20%' height="65" align="center" bgcolor="#f8f8f8" class='oolimmobilemenuM'>관리자답변</td>
										<td style="padding:2em" align="left" class='oolimitembbs'><?=$review->coment?></td>
									</tr>
									<tr>
										<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
									</tr>
