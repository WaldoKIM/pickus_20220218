					...
					<div class="main">
						...
						<table style='width:100%'>
							...
							<?
								...
								?>
							<tr bgcolor='#ffffff' style='border-bottom: 1px solid rgba(0,0,0,0.1);' id='calendar_list_tableTD_on'>
								<td height="35"  align="center" class="oolimitembbs rev_nonoolim">
									<?=$listNo;?>
								</td>
								<td height="35" align="left" class="oolimitembbs">
								...
								<? if( $review_row->coment_check == 1 ) { ?><span class='company_smallBtn03'>답변완료</span><?}else if( $review_row->coment_check == 0 ) { ?><span class='company_smallBtn01'>답변대기</span><?}?>
								<a href="my_review_view.php?board_data=<?=$bbs_data;?>"><?=$review_row->title;?></a>&nbsp;<?=$hold_img?>&nbsp;<?for($i=1;$i<=$review_row->star;$i++){?><i class='fa-star_rev fa-star'></i><?}?>
								</td>
								<td height="35" align="center" class="oolimitembbs noneoolim">
