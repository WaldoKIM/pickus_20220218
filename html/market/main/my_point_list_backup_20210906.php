					...
					<div class="main">	
						...
						<table width="90%" style='margin:0 auto;'>
							...
							<tr id='calendar_list_tableTD_on'>
								...
								<td height="45" class='calendar_list_tableTD_bg' style='text-align:center;'>
									<!-- 포인를 사용한 경우 색상변경 --><? if($row->point < 0) {?><font color="#FF7800"><?=number_format($row->point);?></font><?} else {?><font color="#3A73BF"><?=number_format($row->point);?><?}?></font> 원
								</td>
								<td height="45" class='calendar_list_tableTD_bgright' style='text-align:center;'>
