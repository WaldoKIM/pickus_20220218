...
<div class="<?=$styletxt[0]?>">
	...
	<div class="subitem-title1"><h2>베스트상품</h2> <h1 style='color:#FF6A5F'>Best Item</h1></div>
	<!--이전다음 아이콘-->
