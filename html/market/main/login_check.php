	...
	<? include('./include/top_menu.inc.php');?>
		...
		<div class="my_location">
			<ol class="breadcrumb titletxt_B">
				...
				<li><i class="fas fa-arrow-left"></i>로그인체크</li>
			</ol>
		</div>
		<!--//페이지 위치-->
	</section>
	<!--컨텐츠 출력1 시작-->
	<section id="blog" class="section login_check_area">
			...
			<div class="row">
				<div class="to_animate">
					...
					<ul class="top_ment">
						...
						<li class="text">로그인을 하시면 각종 서비스와 상품주문시 <span>적립금</span>을 받으실 수 있습니다.</li>
						<li class="btn">
							<a href="../../bbs/login.php?login_go=<?=$_GET[login_go];?>" class="btn1">회원 구매</a>
							<a href="<?=$_GET[login_go];?>&nologin=1&opt_code=<?=$_GET[opt_code];?>" class="btn2">비회원 구매</a>
						</li>
					</ul>
					<h3 class="tit2">
						<p class="big"><img src="images/login_check_tit.png"><span> 가입혜택</span> <img src="images/login_check_tit.png"></p>
