...
<table width="100%">
	...
	<tr bgColor="white">
		<td width='20%' height="65" align="center" bgcolor="#F2F2F2" class='oolimmobilemenuM'>첨부파일</td>
	...
	<tr bgColor="white">
		...
		<td height="45" style="padding-left:3px" align="left" class='oolimitembbs'><?=$review->title?></td>
	</tr>
	<tr>
		<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
	</tr>
	<tr bgColor="white">
		<td width='20%' height="65" align="center" bgcolor="#F2F2F2" class='oolimmobilemenuM'>평 가</td>
	...
	<tr bgColor="white">
		<td width='20%' height="65" colspan="2"  align="center" bgcolor="#F2F2F2" class='oolimmobilemenuM'>내 용</td>
	</tr>
	<tr>
		<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
	</tr>
	<tr>
		<td colspan="2" style="padding:2em 1em" align="left" class='oolimitembbs'><?=$review->content?></td>
	</tr>
	<tr>
		<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
	</tr>
	...
	<tr bgColor="white">
		<td width='20%' height="65" colspan="2"  align="center" bgcolor="#F2F2F2" class='oolimmobilemenuM'>답 변</td>
	<tr>
		<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
	</tr>
	<tr>
		<td colspan="2" style="padding:2em 1em" align="left" class='oolimitembbs'><?=$review->coment?></td>
	</tr>
	<tr>
		<td width="7" colspan="2" height="1" bgColor='#dddddd'></td>
	</tr>
