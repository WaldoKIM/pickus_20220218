...
if ($pginfo->pg_true == 1) $urlSeting = "paygw.kcp.co.kr";
else  $urlSeting = "testpaygw.kcp.co.kr";
?>
<?
/* ============================================================================== */
/* =   01. 지불 데이터 셋업 (업체에 맞게 수정)                                  = */
/* = -------------------------------------------------------------------------- = */
$g_conf_home_dir  = $ROOT_DIR . "/payplus"; // BIN 절대경로 입력
$g_conf_log_level = "3";                      // 변경불가
$g_conf_pa_url    = $urlSeting;    // real url : paygw.kcp.co.kr , test url : testpaygw.kcp.co.kr
