				...
				<div class="to_animate">
					...
					<div class="order_list_area">
						...
						<ul class="data_cell">
							...
							<li style="display:none;" class="point"><span><?=number_format($trade_data[goods_price]*$trade_data[goods_cnt]*$trade_data[goods_point]*0.01);?></span>point</li>
					...
					<table style='margin:0 auto;'>
						<?
							...
							<script language='javascript' src='<?if($pginfo->pg_true=="1"){?>https://pay.kcp.co.kr/plugin/payplus_web.jsp<?}else{?>https://testpay.kcp.co.kr/plugin/payplus_web.jsp<?}?>'></script>
							<script language='javascript'>
