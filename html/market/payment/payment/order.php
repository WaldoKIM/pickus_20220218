			...
			?>
								...
								<tr>
									<td>
										<b>결제방법</b>
										<br/>
										<input type="radio" name="pay_method" value="100000000000" checked > 신용카드
										<input type="radio" name="pay_method" value="010000000000" > 계좌이체
										<input type="radio" name="pay_method" value="001000000000" > 가상계좌
										<?/*
								...
								<div class="btnset" id="display_pay_button" style="display:block">
									<div class="paybtn">
										<input name="" type="button"  class="pay_start" value="결제요청" onclick="jsf__pay(this.form);" />
