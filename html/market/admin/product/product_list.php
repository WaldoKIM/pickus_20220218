									...
									<tr> 
										...
										<table width="100%" border="0">
												...
												<td>
													<table  width="100%">
														<tr>
															...
															<table>
																<tr>
																	<td class="sub_titleM"><img src="../img/left_menu_2013icon4.gif" align="absmiddle" border="0">제품목록</td>
																</tr>
															</table>
																							...
																							<tr>
																								<td bgcolor="#E9F2F8">
																									<table width="100%">
																										...
																										<tr>
																											<td class='sensbody'>카테고리를 선택하시면(1차 → 2차 → 3차)<br>아래와 같이 해당 카테고리에 등록된 제품 목록이 나오게 됩니다.</td>
																										</tr>
																									</table>
																								</td>
																							</tr>
																					...
																					<!--도움말--->
																						...
																						<div class='oolimbox-wrapper oolimbox-grid3'>
																							<div class='oolimbox-col_3dan' style='text-align:center;'>
																								...
																								<select name="select1" size="7" class='itemSelect' style="width:98%;" onchange='change(1, this.form.select1.selectedIndex, this.form)'>
																									<script language = "javascript">
																							...
																							<div class='oolimbox-col_3dan' style='text-align:center;'>
																								...
																								<select name="select2" size="7" class='itemSelect' style="width:98%;"  onchange='change(2, this.form.select2.selectedIndex, this.form)'>
																								</select>
																							</div>
																							<div class='oolimbox-col_3dan' style='text-align:center;'>
																								<span style='font-size:11pt;'>3차카테고리</span>

																								<select name="select3" size="7" class='itemSelect' style="width:98%;" onchange='change(3, this.form.select3.selectedIndex, this.form)'>
																								</select>
																							</div>
																						</div>
																				</td>
																				...
																				<td style='padding:5px;'>
																								...
																								<td bgcolor="#E9F2F8">
																									<table width="100%">
																										...
																										<tr>
																											...
																											카테고리내 검색을 이용하지 않을 경우에는 전체 상품을 기준으로 검색됩니다.<br><font color="red">품절상품 검색</font>은 품절된 상품내에서만 검색됩니다.</td>
																										</tr>
																									</table>
																								</td>
																							</tr>
																					...
																					<table>
																						...
																						<tr>
																							...
																							<input type="checkbox" value="1" name="addsearch" <?if($addsearch==1){?>checked<?}?> onclick="part_value_auto()"> 카테고리내 검색 <input type="checkbox" value="1" name="search_name" <?if($search_name==1){?>checked<?}?> onclick="check_item_number()"> 품절상품 검색
																							</td>
																						</tr>
																						<tr>
																							<td class='sensbody'>
																							<input type="text" name="search_code" class="formText" value='<?=$search_code?>' onclick="document.goods_form.search_name.checked=false"> <font color='000000'>수량검색</font>-입력한 수량과 같거나 이하일경우 검색되며 <font color="red">품절상품 및 무제한설정은 제외</font>됩니다.
																							</td>
																						</tr>
																						<tr>
																							<td>
											...
											<table>
												...
												$totalList	= $db->object( $table, "where 1 $isWhere","count(b.idx ) t_cnt");				
												$totalList = $totalList->t_cnt;		
												$result		= $db->select( $table, "where 1 $isWhere order by part_idx desc, idx desc LIMIT $startPage, $listScale","a.*,b.part1_code,b.part2_code,part3_code" );
												?>
												<table width="100%" class="table_all">
												<tr bgcolor="E4E7EF">
													<td height="35" class='contenM tabletd_all'>제품 위치별 검색</td>
												</tr>
												<tr>
											...
											<table width="100%" class="table_all" border=1>
												...
												<tr>
													...
													<td height="25" bgcolor="C4CADB" class='contenM tabletd_all noneoolimmoL'>제품명</td>
											...
											<?}?>
												...
												<tr id='calendar_list_tableTD_on'>
													...
													*/?>
													...
													<?
														$seller_stat = $db->object("cs_member","where userid='$row->seller'");
													?>
															판매자 : <?=$row->seller?>(<?=$seller_stat->name?>)<br>
