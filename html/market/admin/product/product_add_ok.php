...
if( $tools->chkDigit($_POST[part_code] )) {
	...
	// $resize=$_POST['resize']?$_POST['resize']:0;
	...
	$sql = "part_idx=$part_row->idx, display='$_POST[display]', subitem='$_POST[subitem]', subitemtarget='$_POST[subitemtarget]', itemlist='$_POST[itemlist]', tag='$_POST[tag]', 
			...
			fieldname15='$addfieldname15', fielddata15='$addfielddata15', area='$_POST[area]', model_name='$_POST[model_name]', deliv_fee='$_POST[deliv_fee]', deliv_exc='$_POST[deliv_exc]',editorlist='$_POST[editorlist]'";
