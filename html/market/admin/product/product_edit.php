									...
									<tr> 
										<td height="75" valign="top" bgcolor="#FFFFFF" class="menu"><br> 
											...
											<table width="100%" class="table_all">
												...
												<tr bgColor="white"> 
													<td bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>소비자가격</td>
													<td height="25"  class='tabletd_all tabletd_small'><input name="old_price" type="text"  class="formText" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?> value="<?=$row->old_price;?>">&nbsp;원&nbsp;&nbsp;(판매가격을 입력해주세요)</td>
												</tr>
												<tr bgColor="white"> 
													<td bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>판매가격</td>
													<td height="25"  class='tabletd_all tabletd_small'><input name="shop_price" type="text"  class="formText" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?> value="<?=$row->shop_price;?>">&nbsp;원&nbsp;&nbsp;(할인할 상품 가격을 입력해주세요)</td>
												</tr>												
												<tr bgColor="white"> 
												...
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small' colspan="2">
														...
														<br>
														<input name="area" type="text" class="formText" style="width:90%;" value="<?=$row->area;?>"readonly>
														<br>
