																				...
																				<table width="100%">
																					...
																					<tr>
																						<td>분류선택 : 1차 → 2차 → 3차.<br>
																							...
																							상품순위는 현재 카테고리의 상품중 제일높은 순위의 값이 등록이 됩니다. 상품통합관리에서 상품순위를 변경하셔서 사용하시면 됩니다.<br>
									...
									<tr> 
										...
										<table width="100%" style='<?if(!$_POST[display_view]){?>display:none;<?}?>'>
																			...
																			<td bgcolor="#E9F2F8">
																				<table width="100%">
																					...
																					<tr>
																						...
																						간략한설명 : 검색엔진최적화에 사용될 description 로 사용됩니다.<br>
																						</td>
																					</tr>
																				</table>
																			</td>
											...
											<table width="100%" class="table_all" style='<?if(!$_POST[display_view]){?>display:none;<?}?>' id="product_info" name="product_info">
												...
												<tr bgColor="white"> 
													<td width="20%" height="25" bgcolor="E4E7EF"  align="center" class='contenM tabletd_all'>소비자가격</td>
													<td class='tabletd_all tabletd_small' colspan="2"><input name="old_price" type="text" class="formText" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?>>&nbsp;원&nbsp;&nbsp;(판매가격을 입력해주세요)</td>
												</tr>
												<tr bgColor="white"> 
													<td width="20%" height="25" bgcolor="E4E7EF"  align="center" class='contenM tabletd_all'>판매가격</td>
													<td class='tabletd_all tabletd_small' colspan="2"><input name="shop_price" type="text" class="formText" maxlength="11" size="11" <?=$style->align(2);?> <?=$style->strCheck(0);?>>&nbsp;원&nbsp;&nbsp;(할인할 상품 가격을 입력해주세요)</td>
												</tr>
												...
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small' colspan="2"><input name="unlimit" type="checkbox" value="1" onClick="goodsUnlimit()" checked>무제한&nbsp;<input name="number" type="text" maxlength="11" size="11" class="formText" <?=$style->align(2);?> <?=$style->strCheck(0);?>  onClick="goodsNumber()">&nbsp;개&nbsp;&nbsp; (재고량이 없는 경우 0를 입력해 주세요[품절표시])</td>
												</tr>
												<tr bgColor="white"> 
												...
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small' colspan="2">
														...
														<br>
														<input name="area" type="text" class="formText" style="width:90%;"  readonly>
														<br>
												...
												<tr bgColor="white"> 
													<td width="20%" bgcolor="E4E7EF"  align="center" class='contenM tabletd_all'>자동리사이징</td>
												...
												<tr bgColor="white"> 
													<td bgcolor="E4E7EF" height="25" align="center" class='contenM tabletd_all'>샘플파일 등록</td>
																					...
																					<table width="100%">
																						...
																						<tr>
																							...
																							<td height="5" valign="top">
																								...
																								<font color="red">예)</font> 전자상품을 판매를 하신다면 아래의 링크에서 "상품정보제공의 상품군별 추가필드 항목 알아보기" 문서를 다운받아 전자상품에 해당하는 추가정보 항목을 찾으신 후 <font color='red'>'항목추가' 버튼</font>을 이용하여 항목명칭 입력후 그에 대한 정보를 입력하시기 바랍니다. 좌측의 이미지처럼 품명 및 모델명 이란 정보항목과 상성 MP3 - 001002 정보를 등록하여 상품 상세정보의 추가정보에서 노출되는 예입니다.
																								<br><br>
