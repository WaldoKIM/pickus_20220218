					...
					<table  width="100%">
						<tr>
							<td>
								<!--콘텐츠출력-->
								<table width="100%">
									<form action="category_edit1_ok.php" method="post" name="part_form" enctype="multipart/form-data">
										...
										<table width="100%">
											...
											<table width="100%" class="table_all">
												...
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small'>&nbsp;<input type="radio" name="part_low_check" value="0" <? if( $edit_row->part_low_check == 0 ) { echo( 'checked' ); }?>>&nbsp;미사용&nbsp;&nbsp;<input type="radio" name="part_low_check" value="1" <? if( $edit_row->part_low_check == 1 ) { echo( 'checked' ); }?>>&nbsp;사용&nbsp;&nbsp;&nbsp;(2, 3차 카테고리를 등록 유무 설정)</td>
												</tr>
												<tr bgColor="white"> 
