							...
							<td>
								<!--콘텐츠출력-->
									<table width="100%" border="0" align="center">
										<form action="page_add_ok.php" method="post" name="page_form" enctype="multipart/form-data">
										<tr> 
											...
											<table width="100%">
													...
													<td>
														<table width="100%">
															<tr>
																...
																<table>
																	<tr>
																		<td class="sub_titleM"><img src="../img/left_menu_2013icon4.gif" align="absmiddle" border="0">페이지추가</td>
																	</tr>
																</table>
																</td>
															</tr>
												...
												<table width="100%" class="table_all">
													<tr bgColor="white"> 
														...
														<td height="25" class='tabletd_all tabletd_small'><input name="page_index" type="text" class="formText" maxlength="40" <?=$style->strCheck(2);?>> 페이지의 일련번호(영문 or 숫자 작성)</td>
													</tr>
													<tr bgColor="white"> 
														<td width="15%" height="25" align="center" bgcolor="E4E7EF" class='contenM tabletd_all'>페이지 타이틀</td>
														<td height="25" class='tabletd_all tabletd_small'><input name="title" type="text" class="formText"> 간단한 설명</td>
													</tr>
													<tr bgColor="white"> 
