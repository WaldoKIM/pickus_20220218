					...
					<table  width="100%">
						<tr>
							<td>
								<!--콘텐츠출력-->
								<table width="100%">
									<form action="category_edit3_ok.php" method="post" name="part_form" enctype="multipart/form-data">
										...
										<table width="100%">
												...
												<td>
													<table width="100%">
														<tr>
															...
															<table>
																<tr>
																	<td class="sub_titleM"><a name="teb01"></a><img src="../img/left_menu_2013icon4.gif" align="absmiddle" border="0">3차카테고리수정</td>
																</tr>
															</table>
															</td>
														</tr>
											...
											<table width="100%" class="table_all">
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small'>&nbsp;&nbsp;<font color="#FF0000">3차 카테고리 수정</font></td>
												</tr>
												<tr bgColor="white"> 
													<td width="120" height="35" align="center" bgcolor="E4E7EF" class='contenM tabletd_all'>카테고리 이름</td>
													<td class='tabletd_all tabletd_small'>&nbsp;<input name="part_name" type="text" class='formText' maxlength="100" size="30" value="<?=$edit_row->part_name;?>">&nbsp;&nbsp;카테고리 이름을 어주세요(예:컴퓨터)</td>
												</tr>
												<tr bgColor="white"> 
													<td width="120" height="35" align="center" bgcolor="E4E7EF" class='contenM tabletd_all'>카테고리 코드</td>
													<td class='tabletd_all tabletd_small'>&nbsp;1차 코드&nbsp;<input name="part1_code" type="text" class='formText' maxlength="20" size="10" value="<?=$edit_row->part1_code;?>" readonly <? $style->colorAlign('#666666', 0);?>><br>2차 코드&nbsp;<input name="part2_code" type="text" class='formText' maxlength="20" size="10" value="<?=$edit_row->part2_code;?>" readonly <? $style->colorAlign('#666666', 0);?>>&nbsp;3차 코드&nbsp;<input name="part3_code" type="text" class='formText' maxlength="20" size="10" value="<?=$edit_row->part3_code;?>" readonly <? $style->colorAlign('#666666', 0);?>>&nbsp;&nbsp;카테고리 코드는 수정할수 없습니다.</td>
												</tr>
												<tr bgColor="white"> 
