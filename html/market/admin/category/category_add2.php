					...
					<table  width="100%">
						<tr>
							<td>
								<!--콘텐츠출력-->
								<table width="100%">
									<form action="category_add2_ok.php" method="post" name="part_form" enctype="multipart/form-data">
										...
										<table width="100%">
												...
												<td>
													<table width="100%">
														<tr>
															...
															<table>
																<tr>
																	<td class="sub_titleM"><a name="teb01"></a><img src="../img/left_menu_2013icon4.gif" align="absmiddle" border="0">2차카테고리등록</td>
																</tr>
															</table>
															</td>
														</tr>
											...
											<table width="100%" class="table_all">
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small'>&nbsp;&nbsp;2차 카테고리 등록</td>
												</tr>
												<tr bgColor="white"> 
												...
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small'>&nbsp;1차 코드&nbsp;<input name="part1_code" type="text" class="formText" maxlength="20" size="15" value="<?=$part2_row->part1_code;?>" readonly <? $style->colorAlign('#666666', 0);?>><br>2차 코드&nbsp;<input name="part2_code" type="text" class="formText" maxlength="20" size="15" value="<?=time();?>" readonly <? $style->colorAlign('#666666', 0);?>>&nbsp;&nbsp;카테고리 코드는 자동으로 생성 됩니다.</td>
												</tr>
												<tr bgColor="white"> 
												...
												<tr bgColor="white"> 
													...
													<td class='tabletd_all tabletd_small'>&nbsp;<input type="radio" name="part_low_check" value="0" checked>&nbsp;미사용&nbsp;&nbsp;<input type="radio" name="part_low_check" value="1">&nbsp;사용&nbsp;&nbsp;&nbsp;(3차 카테고리를 등록 유무 설정)</td>
												</tr>
												<tr bgColor="white"> 
