										...
										<td height="150" align="center" valign="top" bgcolor="#FFFFFF">
														...
														<table width="100%">
															<tr>
																<td height="25">
																	<table>
																		<tr>
																			<td class="sub_titleM"><img src="../img/left_menu_2013icon4.gif" align="absmiddle" border="0">인기상품</td>
																		</tr>
																	</table>
																</td>
															</tr>
																			...
																			<tr>
																				<td bgcolor="#E9F2F8">
																					<table width="100%">
																						...
																						<tr>
																							<td>상품의 매출과는 상관없이 조회수가 높은 상품순으로 출력됩니다.</td>
																						</tr>
																					</table>
																				</td>
																			</tr>
											...
											<table width="100%" class="table_all">
												...
												<?
													...
													// 검색
													$totalList = $db->cnt("cs_goods", "where display=1");
													$result = $db->select("cs_goods", "where display=1 order by click desc LIMIT $startPage, $listScale");
													// 페이지넘버
											...
											<table width="100%" height="55">
												<tr>
													<td height="25" style='text-align:center'>
														<a href="crm0_download.php" class='search_bbs1'>액셀판일 다운로드 (*.CSV)</a>
													</td>
												</tr>
											</table>
										</td>
