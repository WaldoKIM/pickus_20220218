...
function pointDel( idx, userid ) {
    var choose = confirm( '수익금를 삭제 하시겠습니까?');
	if(choose) {	location.href='cash_del_ok.php?idx='+idx+'&userid='+userid; }
	else { return; }
}
//-->
</script>
...
<table width="400">
	<tr>
		<td align="center"><br>
			<table width="350">
				<tr>
					<td height="60" class='sub_titleL'><img src="../img/left_menu_2013icon3.gif" align="absmiddle" border="0" hspace="5">수익금관리</td>
				</tr>
			</table>
			<table width="350" class="table_all">
				<form action="cash_ok.php" method="post" name="point_form">
				...
				<tr>
					<td width="100" align="right" class='contenM tabletd_all'>수익금</td>
					<td class='contenM tabletd_all'><select name="sum" class="formText_mo">
							...
							<a href="javascript:sendit();" class="itemtable_default_bt2">저장하기</a>
					</td>
				</tr>
				</form>
			</table>
	...
	<tr>
		<td align="center" height='30'>
			<table width="600">
				<tr>
					<td class="tmb">Total : <font color="#FF0000">	<? $total_point = $db->sum("cs_cash", "where userid='$userid'", "point"); echo(number_format($total_point));?></font> 원</td>
				</tr>
			</table>
		</td>
	</tr>
