									...
									<tr>
										<td bgcolor="#E9F2F8">
											...
											<table width="100%">
												...
												<tr>
													<td>
													<img src="../img/content_snsicontip.jpg" border="0"><br>
						...
						<tr>
							...
							<table width="100%" class="table_all">
								...
								<tr>
									...
									<td class='sensp tabletd_all'><input name="linkurl" type="text" class="formText formText_subject" value="<?=$row->linkurl?>">
									</td>
								</tr>
								</form>
							</table>
