		...
		<table width="100%">
			<tr>
				<td height="20" class='sub_titleL'>
					<img src="../img/left_menu_2013icon3.gif" align="absmiddle" border="0" hspace="5">이벤트 등록 및 관리
				</td>
			</tr>
			<tr>
						...
						<tr>
							<td>
								...
								<table width="100%" border="0" align="center">
									<form action="main_flash_edit_ok.php" method="post" name="banner_form" enctype="multipart/form-data">
										...
										<table width="100%" class="table_all">
											...
											<tr bgColor="white">
												...
												<td height="35" class='sensP tabletd_all'>
													<input type="radio" name="txttype" value="1" onclick="txt_type()" <?if($row->txttype==1){?>checked<?}?>> 이미지  <input type="radio" name="txttype" value="2" onclick="txt_type()" <?if($row->txttype==2){?>checked<?}?>> 텍스트<br>
											...
											<tr>
												...
												<input name="subject" type="text" class="formText formText_subject" value="<?=$row->subject?>"> (간단한 설명)
												<br>
												<input name="title_color" id="title_color" type="text" class="formText" size="10" class="formText"  value="<?=$row->title_color;?>">&nbsp;<a href="#" class='modal searchC' data-modal-height="500" data-modal-width="484" data-modal-iframe="../rgbcolor.php?value=title_color" data-modal-title="색상코드">색상코드</a>
												</td>
											</tr>
											<tr bgColor="white" id="txt2" style="display:none">
												...
												<td height="35" class='sensP tabletd_all'>
													<input name="title2" type="text" class="formText formText_subject" value="<?=$row->title2;?>">&nbsp;<br>
													<input name="title2_color" id="title2_color" type="text" class="formText" size="10" class="formText" value="<?=$row->title2_color;?>">&nbsp;<a href="#" class='modal searchC' data-modal-height="500" data-modal-width="484" data-modal-iframe="../rgbcolor.php?value=title2_color" data-modal-title="색상코드">색상코드</a>
												</td>
											</tr>
											<tr bgColor="white" id="txt3" style="display:none">
												...
												<td height="35" class='sensP tabletd_all'>
													<input name="title3" type="text" class="formText formText_subject"  value="<?=$row->title3;?>">&nbsp;<br>
													<input name="title3_color" id="title3_color" type="text" class="formText" size="10" class="formText" value="<?=$row->title3_color;?>">&nbsp;<a href="#" class='modal searchC' data-modal-height="500" data-modal-width="484" data-modal-iframe="../rgbcolor.php?value=title3_color" data-modal-title="색상코드">색상코드</a>
												</td>
											</tr>
											<tr id="img1" style="display:none">
												<td width="200" height="25" align="center" height="35" bgcolor="#F0E8E8" class='contenM tabletd_all'>
													<font color='#E84C4B'>텍스트 문구 이미지 등록</font>
												</td>
												<td class='sensP tabletd_all'>
													<? if( $row->txtimg) { ?><a href="../../data/designImages/<?=$row->txtimg?>" rel="lightbox" class="menusmall_btn3">이미지 미리보기</a><? }?><input type="checkbox" name="del_txtimg" value="1">삭제시 선택해주세요[삭제우선]<br>&nbsp;<input name="txtimg" type="file" class="file_text" size="60">
												</td>
											</tr>
											<tr>
												...
												<td class='tabletd_all sensP'>
												<input name="main" type="checkbox" value="1" <?if($row->main=="1"){?>checked<?}?>> 선택하실 경우 메인에 노출됩니다. 그외 항목은 목록에서 링크가 가능합니다.
												</td>
											</tr>
											<tr bgColor="white">
												...
												<td height="35" class='sensP tabletd_all'>
													<input name="linktitle" type="text" class="formText" value="<?=$row->linktitle;?>" placeholder="예) 바로가기">
												</td>
											</tr>
											<tr>
												<td width="200" height="25" align="center" height="35" bgcolor="#E4E7EF" class='contenM tabletd_all'>
													버튼설정 [URL]
												</td>
												<td class='sensP tabletd_all'>
													<input name="url" type="text" class="formText"value="<?=$row->url;?>">
													<select size="1" name="urlselect" onclick="urlchoice(this.value)" class='formSelect'>
														<option value="">메뉴 선택</option>
														<option value="event_view.php?idx=<?=$row->idx?>">이벤트상세보기</option>
											...
											<tr>
												...
												<td class='sensP tabletd_all'>
													<input type="radio" name="target" value="0" <? if( $row->target == 0 ) { echo("checked");}?>> 새창 <input type="radio" name="target" value="1" <? if( $row->target == 1 ) { echo("checked");}?>> 현재창
												</td>
											</tr>
											<tr>
												<td width="200" height="25" align="center" height="35" bgcolor="#EBF1D9" class='contenM tabletd_all'>
													<font color='#E84C4B'>액센트 이미지</font>
												</td>
												<td class='sensP tabletd_all'>
													<? if( $row->main_img) { ?><a href="../../data/designImages/<?=$row->main_img?>" rel="lightbox" class="menusmall_btn3">이미지 미리보기</a><? }?><!--<input type="checkbox" name="del_banner_images" value="1">삭제시 선택해주세요[삭제우선]<br>-->&nbsp;<input name="main_img" type="file" class="file_text" size="60"><br><br>가로 1000픽셀이하 세로 700픽셀 이하로 등록하시기 바랍니다.<br>
											...
											<tr>
												...
												<td class='sensP tabletd_all'>
													<? if( $row->bgimg) { ?><a href="../../data/designImages/<?=$row->bgimg?>" rel="lightbox" class="menusmall_btn3">이미지 미리보기</a><? }?><!--<input type="checkbox" name="del_bgimg" value="1">삭제시 선택해주세요[삭제우선]<br>-->&nbsp;<input name="bgimg" type="file" class="file_text" size="60"> <br><br>가로 1920픽셀 세로 1200픽셀 권장.<br>
													배경이 되는 이미지입니다.
												</td>
											</tr>
											<tr>
												...
												<td class='tabletd_all sensP'>
													<?if($row->list_img){?><a href="../../data/designImages/<?=$row->list_img?>" rel="lightbox" class="menusmall_btn3">이미지 미리보기</a>
													<input type="checkbox" name="list_img_del" value="1">삭제<br>
													<?}?>
											...
											<tr align="center">
												<td height="25" align="center" bgcolor="E4E7EF" colspan="2" class='contenM tabletd_all'>
												<img src="../images/arrow2.gif" width="7" height="7"> 등록하신 이벤트는 스킨에 따라 사용자화면에 다르게 출력되는 경우도 있습니다.
												</td>
											</tr>
