	...
	<tr>
		<td height="70" align="center" valign="top" bgcolor="#FFFFFF" class="menu">
				...
				<td>
					<table width="100%">
						<tr>
							...
							<table>
								<tr>
									<td class="sub_titleM"><a name="teb01"></a><img src="../img/left_menu_2013icon4.gif" align="absmiddle" border="0">배너수정</td>
								</tr>
							</table>
							</td>
						</tr>
											...
											<table width="100%">
												...
												<tr>
													<td>현재 등록되어있는 배너목록이 나타납니다.<br>
														...
														http://사용자도매인/스킨명/include/banner_code1.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code2.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code3.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code4.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code5.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code6.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code7.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code8.inc.php<br>
														http://사용자도매인/스킨명/include/banner_code9.inc.php<br><br><br>
			...
			<table width="100%" class="table_all">
				...
				<input type="hidden" name="idx" value="<?=$_GET[idx];?>">
				<tr>
					<td width="15%" height="25" bgcolor="E4E7EF" class='contenM tabletd_all'>
						형태 선택
					</td>
					<td class='tabletd_all tabletd_small'>
						<input type="radio" name="type" value="1" onclick="bannerReg();" <? if( $row->type == 1 ) { echo("checked");}?>> HTML <input type="radio" name="type" value="2" onclick="bannerReg();"  <? if( $row->type == 2 ) { echo("checked");}?>> 이미지(gif, jpg)
					</td>
				</tr>
				<tr>
					<td width="15%" height="25" bgcolor="E4E7EF" class='contenM tabletd_all'>
				...
				<tr>
					...
					<td class='tabletd_all tabletd_small'>
						<input name="title" type="text" class="formText" value="<?=$row->title;?>"> (간단한 설명)
					</td>
				</tr>
				<tr id="banner_view" style="display:none;">
					...
					<td class='tabletd_all tabletd_small'>
						HTTP://<input name="link_url" type="text" class="formText formText_subject" value="<?=$row->link_url;?>">
					</td>
				</tr>
				<tr id="banner_view" style="display:none;">
					<td width="15%" height="25" bgcolor="E4E7EF" class='contenM tabletd_all'>
				...
				<tr id="banner_view" style="display:none;">
					...
					<td class='tabletd_all tabletd_small'>
						<? if( $row->banner_images) { ?><a href="../../data/designImages/<?=$row->banner_images;?>" rel="lightbox" class='btn_guide1'>미리보기</a><input type="checkbox" name="del_banner_images" value="1">삭제시 선택해주세요[삭제우선]<br><? }?>&nbsp;<input name="banner_images" type="file" class="formText">
					</td>
				</tr>
				<tr id="banner_view" style="display:none;">
					<td width="15%" height="25" bgcolor="E4E7EF" class='contenM tabletd_all'>
				...
				<tr id="banner_view" style="display:none;">
					<td height="25" bgcolor="E4E7EF" class='contenM tabletd_all'>
						배너크기
					</td>
					<td class='tabletd_all tabletd_small'>
						&nbsp;<input name="img_width" type="text" class="formText" size="3" value="<?=$row->img_width?>">가로 <input name="img_height" type="text" class="formText" size="3" value="<?=$row->img_height?>">세로
					</td>
				</tr>
				<tr align="center">
					<td height="25" colspan="2" bgcolor="E4E7EF" class='contenM'>등록하신 배너는 스킨에 따라 사용자화면에 다르게 출력되는 경우도 있습니다.
					</td>
				</tr>
			</table>
			<br> 
