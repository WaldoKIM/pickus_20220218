...
<?
//$_GET=&$HTTP_GET_VARS;
$row = $db->object("cs_bbs_sns", " where idx='$_GET[idx]'");
?>
								...
								<table width="100%" bgcolor="white">
									...
									<tr>
										...
										<table width="100%" class="table_all">
											...
											<tr>
												...
												<td class='sensO tabletd_all'>
													...
													<table width="100%" class="menu">
														<tr>
															<td>
													<img src="../images/facebookicon.PNG" border="0"> 페이스북은 수정불가능합니다.
															</td>
														</tr>
													</table>
													<?}else{?>
											...
											<tr>
												<td width="120" height="25" align="center" bgcolor="#E4E7EF" class='contenM tabletd_all'><?if($row->noedit==1){?>APPID<?}else{?>링크설정<?}?></td>
												<td class='sensp tabletd_all'><input name="linkurl" type="text" class="formText" size="70" class="formText" value="<?=$row->linkurl?>">
												<?if($row->noedit==1){?><br>
												페이스북에서 발급받은 APPID를 입력하여 주세요. 
												<?}else{?><br>
