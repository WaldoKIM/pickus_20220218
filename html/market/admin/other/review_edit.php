...
<div class="oolimbox-wrapper oolimbox-grid2">
	...
	<article class="oolimbox-grid-box02">
		<table width="100%">
			<tr>
				<td height="20" class='sub_titleL'><img src="../img/left_menu_2013icon3.gif" align="absmiddle" border="0">제품사용후기</td>
			</tr>
			<tr>
	...
	<tr> 
		...
		<table width="100%">
			...
			<table width="100%" class="table_all">
				<form name="write_form" action="review_edit_ok.php" method="post" enctype="multipart/form-data">
				...
				<tr bgColor="white"> 
					<td width="20%" height="35" bgcolor="E4E7EF" class='contenM tabletd_all'>사 진</td>
					<td class='tabletd_all tabletd_small'>&nbsp;&nbsp;<input type="file" name="bbs_file" class="formText" style="width:50%"><?if($review->bbs_file != "none"){?>&nbsp;<input type="checkbox" value="1" name="del_bbs_file">삭제시 선택하여주세요[삭제우선]!<?}?></td>
				</tr>
				<tr bgColor="white"> 
				...
				<tr bgColor="white"> 
					...
					<td class='tabletd_all tabletd_small'>&nbsp;&nbsp;
						<input name="name" type="text" class="formText" value="<?=$review_stat->name;?>">
						<?=$review_stat->userid;?>(<?=$review_stat->name;?>)&nbsp;&nbsp;&nbsp;
					<a href="#" class='modal searchC' data-modal-height="300" data-modal-width="418" data-modal-iframe="../member/point.php?userid=<?=$review_stat->userid;?>" data-modal-title="포인트추가">포인트추가</a></td>
				</tr>
				<tr bgColor="white"> 
					<td width="20%" height="35" bgcolor="E4E7EF" class='contenM tabletd_all'>작성일</td>
					<td class='tabletd_all tabletd_small'><input name="name" type="text" class="formText" value="<?=$review_stat->register;?>"></td>
				</tr>
				</form>
			</table><br>
			...
			<table style='margin:0 auto;'>
				<tr>
					<td height='70'><a href="javascript:writeSendit();" class="oolimbtn-botton1_1"> 등록 </a>&nbsp;<a href="review.php?review_data=<?=$mv_data;?>" class="oolimbtn-botton1"> 돌아가기</a></td>
				</tr>
			</table>
