<?php
	...
	$email = $member['mb_id'];
	$sql = "select * from g5_estimate_match AS a JOIN g5_estimate_match_propose AS b ON a.no_estimate = b.no_estimate JOIN g5_estimate_match_propose_detail AS c ON b.no_estimate = c.no_estimate WHERE a.email = '$email' AND a.pay_confirm = 1 AND b.selected = 1 AND a.pay_confirm = 1 order by a.no_estimate desc";
				...
				<table class="requst_list">
					...
					<tbody>
						...
						for ($i=0; $row=sql_fetch_array($result); $i++) {
							...
							echo "<td style='text-align:center'>".number_format($price_total)."원</td>";
