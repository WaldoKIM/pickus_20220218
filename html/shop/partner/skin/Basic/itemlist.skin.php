...
<h1><i class="fa fa-cube"></i> 내 상품</h1>
...
<div class="well" style="padding-bottom:3px;">
	...
	<input type="hidden" name="save_stx" value="<?php echo $stx; ?>">
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					<button type="submit" class="btn btn-primary btn-sm btn-block"><i class="fa fa-search"></i>검색</button>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="form-group">
					<a href="./?ap=item" class="btn btn-danger btn-sm btn-block"><i class="fa fa-upload"></i>상품등록</a>
				</div>
			</div>
		</div>
	</form>
