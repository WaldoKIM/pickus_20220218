...
$sql_common = " from {$g5['forum_table']} a ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        $bg = 'bg'.($i%2);
        $s_mod = "";
        $s_mod .= '<a href="./pickus_forum_list_delete.php?page='.$page.'&idx='.$row['idx'].'" class="btn btn_01">삭제</a>';
        $s_mod .= '<a href="./pickus_forum_form.php?page='.$page.'&w=u&idx='.$row['idx'].'" class="btn btn_03">수정</a>';
    ?>
...
<div class="btn_fixed_top">
    <a href="./pickus_forum_form.php?w=" id="member_add" class="btn btn_01">추가</a>
</div>
