<?php
$menu['menu300'] = array (
    array('300000', '게시판관리', ''.G5_ADMIN_URL.'/pickus_notice_list.php', 'board'),
    array('300100', '게시판관리', ''.G5_ADMIN_URL.'/board_list.php', 'bbs_board'),
    array('300110', '공지사항 관리', ''.G5_ADMIN_URL.'/pickus_notice_list.php', 'bbs_notice'),
    array('300120', '1:1 문의 관리', ''.G5_ADMIN_URL.'/pickus_qna_list.php', 'bbs_qna'),
    array('300130', 'FAQ 관리', ''.G5_ADMIN_URL.'/pickus_faq_list.php', 'bbs_faq'),
    array('300135', '포럼 관리', ''.G5_ADMIN_URL.'/pickus_forum_list.php', 'bbs_notice'),
    array('300140', '리스트 관리', ''.G5_ADMIN_URL.'/pickus_category_list.php', 'bbs_list'),
    array('300150', '팝업 관리', ''.G5_ADMIN_URL.'/newwinlist.php', 'bbs_popup'),
);
