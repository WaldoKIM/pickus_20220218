...
if($w == "u"){
    $sql = "select a.* from {$g5['notice_table']} a where idx = '$idx' ";
    $row = sql_fetch($sql);
}
...
?>
<form name="fmember" id="fmember" action="./pickus_notice_form_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
...
<div class="btn_fixed_top">
    <a href="./pickus_notice_list.php?<?php echo $qstr ?>" class="btn btn_02">목록</a>
