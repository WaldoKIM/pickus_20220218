...
?>
<form name="fmember" id="fmember" action="./pickus_estimate_match_form_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <th>이름</th>
                        <td>
                            <input type="text" name="nickname" value="<?php echo $estimate['name'] ?>" id="nickname" <?php echo $readonly ?> class="frm_input" style="width:100%">
                        </td>
                        <th>이메일</th>
                        <td>
                    ...
                    <tr>
                        <th>견적신청일시</th>
                        <td>
                            <?php echo $estimate['apply_date'] ?>
                        </td>
                        <th>견적마감일</th>
                        <td>
                            <input type="text" name="deadline" value="<?php echo $estimate['date_close'] ?>" id="deadline" class="frm_input" style="width:100%">
                        </td>
                    ...
                    <tr>
                        <th>배송요청일</th>
                        <td>
                            <input type="text" name="date_req" value="<?php echo $estimate['date_req'] ?>" id="date_req" class="frm_input" style="width:100%">
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <th>제목</th>
                        <td>
                            <input type="text" name="title" value="<?php echo $estimate['title'] ?>" id="title" class="frm_input" style="width:100%">
                        </td>
                        <th>카테고리</th>
                        <td colspan="3">
                    ...
                    <?php for ($i = 0; $row_info = sql_fetch_array($estimate_info); $i++) { ?>
                        <tr>
                            <td><?php echo $row_info['cate_name']; ?></td>
