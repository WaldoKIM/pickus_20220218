...
$sql = " delete from {$g5['estimate_match_propose_detail']} where no_estimate = '$no_estimate' ";
sql_query($sql);
$sql = " delete from {$g5['estimate_match_propose']} where no_estimate = '$no_estimate' ";
sql_query($sql);
$sql = " delete from {$g5['estimate_match']} where no_estimate = '$no_estimate' ";
sql_query($sql);
...
alert("삭제하였습니다.","./pickus_estimate_list_match.php?".$qstr);
?>
