...
<body>
    ...
    .m_css{display: none;}
    .container > .cont_01 > .contico > ul > li > a{font-size: 21px !important; white-space: nowrap;}
    .mob_back{display: none !important;}
    .lt_date{display: none !important;}
    .pic_lt li a{
        font-size: 20px;
      font-weight: bold;
      margin: 10px 0;
    ...
    .pic_lt li .lt_img img{border-radius: 8px; max-width: 100%; max-height: 100%;}
    em{color: #fff;}
    .first03{background-color: #333}
    ...
    .container > .cont_02 > .cont > .pick > h2{margin-bottom: 10px !important;}
    ...
    .container > .cont_01 > .est > .Brea .list > ul li{margin: 0 5px !important;}
    ...
    .pic_lt li:first-of-type{margin-right: 15px;}
    ...
    @media(max-width: 768px){
      .pic_lt li a{font-size: 16px; margin-bottom: 15px;}
      .hd_pops_con{width: 100% !important;}
      .conbox_txt p {color: #666;}
      .conbox_txt em{color: #666;}
      .container > .cont_03 > .how > .how_slider > .service> .serv_box > .swiper-slide .serv_con > .conbox{margin-bottom:  0 !important; overflow: hidden;}
      .container > .cont_03 > .how > .how_slider > .service> .serv_box > .swiper-slide .serv_con > .conbox_09{padding-bottom:  0 !important}
      .container > .cont_03 > .how > .how_slider > .service> .serv_box > .swiper-slide .serv_con > .conbox > p{font-size: 18px !important;}

      .m_css{display: block;}
      .container > .cont_01 > .contico > ul > li > a{font-size: 16px !important;}
      .container > .cont_03 > .how > .how_slider > .service{padding-bottom: 105px;}
      #free_estimate{width: 150px; height: 35px; color: #fff !important; margin-top: 15px; background-color: #fe8e3a !important; border:1px solid #ededed; font-size: 17px; padding: 9px 0; float: none !important;}
      #txt_last{width: 80% !important;}
      .swiper-req{width: 60%; float: right;}
      .container > .cont_01 > .est > .Brea .list > ul{margin-bottom: 0 !important;margin-top: 0 !important}
      .swiper-slide{padding-top: 5px !important; padding-bottom: 5px !important;}
    .pic_lt li:first-of-type{margin-right: 0;}
    .pic_lt li:last-of-type{margin-left: 5% !important;}
    }
    
    @media(max-width:400px){
      .pic_lt li:first-of-type{margin-right:0;}
      .container > .cont_01 > .contico > ul > li > a{font-size:14px !important;}
    }
	</style>
  ...
  <div id="Wrap">
      ...
      <div id="demo" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <!--가로--> <img class="d-block w-100" src="/bbs/images/main_banner.png" alt="비쥬얼이미지1">
      ...
      <section class="cont_03">
        ...
        <div class="pickus_open">
          ...
          <div class="app_down">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.dehuv.pickus" class="more">바로가기</a>
          </div>
        </div>
      </section>
	  <!--
    ...
    <style type="text/css">
        .container > .cont_01 > .est > .Brea .list > ul{max-height: 41px;}
        @media(max-width: 480px){
          img.d-block.w-100 {
            height: 200px;
          }
          .container > .cont_03 > .review > .rev >.swiper-container > .btn > a.next{top: 275px;}
        }
      </style>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
          ...
          $('#won_total').animateNumber({ number: 6719266000 },
            {
              duration: 2000
            });
      });
