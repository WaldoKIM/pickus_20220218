					...
					<tr>
						<td class="info" id="mainTitle">
							...
							if ($master['pay_confirm'] == '1' && $selected == "1") {
								...
								echo "<dt class='col-xs-3'>층수</dt><dd class='col-xs-9'>" . $master['elevator_yn'] . " / " . $master['floor'] . "층" . "</dd>";
							...
							if (($state == "3" || $state == "8") && $selected == "1") {
								...
								echo "<dt class='col-xs-3'>선택견적가격</dt><dd class='col-xs-9'>" . number_format($propose_detail['amt0'] + $propose_detail['amt1'] + $propose_detail['amt2'] + $propose_detail['amt3'] + $propose_detail['amt4'] + $propose_detail['amt5'] + $propose_detail['amt6'] + $propose_detail['amt7'] + $propose_detail['amt8'] + $propose_detail['amt9'] + $propose_detail['amt10'] + $master['shipping']);
								"원</dd>";
							} else if ($state == "5" && $selected == "1") { ?>
								<dt class='col-xs-3'>견적가격</dt>
								<dd class='col-xs-9'><?php echo number_format($propose_detail['amt0'] + $propose_detail['amt1'] + $propose_detail['amt2'] + $propose_detail['amt3'] + $propose_detail['amt4'] + $propose_detail['amt5'] + $propose_detail['amt6'] + $propose_detail['amt7'] + $propose_detail['amt8'] + $propose_detail['amt9'] + $propose_detail['amt10'] + $master['shipping']); ?>원</dd>
							<?php
							}
							echo "</dl>";
							?>
...
<div style="z-index: 99999999;" class="modal fade modal_table" id="modal_price" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    align-items: center;"class="form_new add_pro">
									<div style="width:40%;" class="add_name col-xs-5"><input placeholder="품목명" type="text" name="pro_name[]" value="' . $item . '"></div>
									<div style="width:40%; display:flex; align-items:center;" class="add_qty col-xs-5"><input  placeholder="가격" type="number" name="pro_price[]" value="' . $amt . '"><p>원</p></div>
									<a style="width:20%; margin:0; line-height:36px;" class="form_btn delete_item" href="javascript:" >삭제</a>
								...
								?>
								<a class="add_line" id="add_goods" style="width:20%;background:#1379cd; text-align:center; border-radius: 5px;white-space: nowrap;" href="#">+ 추가</a>
							</div>
						</div>
					...
					<div class="form-group one_line" id="delivery" style="padding-bottom: 0rem; border:none;">
						<p style="font-weight:500; font-size:18px;" class="tit_modal_match">배송비</p>
						...
						<div class="row">
							<li class="col-xs-12">
								...
								?>
								<input style="display: none;" type="number" placeholder="숫자만 입력해주세요" value="<?php echo $propose['shipping'] ?>" name="shipping_pro" id="del_fee">
							</li>
						</div>
					</div>
					...
					<div class="form-group one_line" id="guarantee" style="border:0 !important; margin-bottom:0rem">
						<p style="font-weight:500; font-size:18px;" class="tit_modal_match">AS 보증/교환</p>
						<ul class="row" style="margin-top:-1rem;">
							<li class="col-xs-6">
								<label style="width: 100%;" class="box">
					...
					<div class="form-group" style="border:0 !important; margin-bottom:5px; padding-bottom:0;">
						<p style="margin-bottom:0; font-weight: 700;" class="tit_modal_match">참고사항</p>
					...
					<div class="btn_wrap" style="padding-top:3%;">
						<ul class="row">
							...
							<li class="col-xs-6"><a href="#." class="main_bg" id="main_bg_one" onClick="doSavePriceDetail();">확인</a></li>
						</ul>
					</div>
