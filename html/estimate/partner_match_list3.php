...
$sql_common = " from
					{$g5['match_list']} a
					join {$g5['match_propose']} b on a.idx = b.match_idx and b.rc_email = '{$member['mb_email']}' and b.selected = '1' ";
...
{
	location.href="./partner_match_form.php2?idx="+idx+"&&page=<?php echo $page; ?>";
}	
</script>
<?php
