...
<div class="member com_pd">
	<div class="container">
		...
		<div class="work_flow">
			...
			<p> > </p>
			<a class="fill_02" href="#testss2">사진 및 참고사항</a>
			<p> > </p>
			<a class="fill_03" href="#testss3">지역 선택</a>
			<p> > </p>
			<a class="fill_04" href="#testss4">업체 문의</a>
			<p> > </p>
			<a class="fill_05" href="#testss5">고객 정보</a>
		</div>
		<div class="mob_work_flow">
			<a class="fill_01" href="#testss1">1.맞춤 정보</a>
			<a class="fill_02" href="#testss2">2.사진 및 참고사항</a>
			<a class="fill_03" href="#testss3">3.고객 정보</a>
		...
		<div class="request" style="margin-bottom:70px;">
			<div class="form_wrap">
				<form name="frmregister" action="<?php echo G5_URL; ?>/estimate/estimate_register2D_update.php" method="post" enctype="multipart/form-data" autocomplete="off">
						...
						<div class="form_section_value">
							...
							<div class="form-group">
								<ul>
									...
									<li>
										<textarea id="content" name="content" placeholder="품목리스트와 수량 년식을 적어주세요.
( 예시:
	- 삼성 TV 1대, 2015년식
	- LG 냉장고 1대, 2016년식 )
										"></textarea>
...
<!--==============섹션 - 입력 영역====================-->
						...
						<div class="btn_wrap btn_posi" >
									...
									<input class="main_bg" type="button" value="견적신청하기"   style="margin-right:10px; width: 130px;" onClick="doRegistEstimate();">
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="modal-body">
				<form name="frmsimple" action="<?php echo G5_URL; ?>/estimate/estimate_register_simple_update.php" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="btn_wrap">
						<ul class="row">
							<li class="col-xs-4 col-xs-offset-4"><a class="line_bg" href="#" data-dismiss="modal">닫기</a></li>
							<li class="col-xs-4"><input class="main_bg"  type="button" value="간편신청" onClick="doSaveSimpleEstimate();" style="margin-top: 0 !important;"></li>
						</ul>
					</div>
				</form>
			</div>
