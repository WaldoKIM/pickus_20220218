...
include_once(G5_PATH.'/headA.php');
?>
        ...
        <div class="header">
            <div class="container">
                ...
                <div class="mob_title">
                    ...
                    <div class="mob_center">
                        ...
                        <a href="/estimate/estimate_register1A.php" class="mob_sel01">중고가전/가구 매입</a>
                        <a href="/estimate/estimate_register2D.php" class="mob_sel02">대량 매입</a>
                        <a href="/estimate/estimate_register3A.php" class="mob_sel03">철거/원상복구</a>
                ...
                <div class="title">
                    ...
                    <div class="menu">
                        ...
                        <div class="menu_selecter" onclick="menu_btn()">
                            <a>▼</a>
                            <div class="sel_01"><a href="/estimate/estimate_register1A.php">중고가전/가구 매입</a></div>
                            <div class="sel_02"><a href="/estimate/estimate_register2D.php">대량 매입</a></div>
                            <div class="sel_03"><a href="/estimate/estimate_register3A.php">철거/원상복구</a></div>
            ...
            <!--===================== 버전 2 ====================================-->
				...
				<div class="mob_title">
					...
					<img src="../../../img/main/mob_main_slide_01v2.png">
					<div class="mob_work_select_area" onclick="work_select_btn()">
						<a href="/estimate/estimate_register1A.php">
							<img src="../../../img/main/title_slide_img01.png">
							<p>중고가전/가구 매입</p>
						</a>
						<a href="/estimate/estimate_register2B.php">
							<img src="../../../img/main/title_slide_img02.png">
							<p>대량 매입</p>
						</a>
						<a href="/estimate/estimate_register3A.php">
							<img src="../../../img/main/title_slide_img03.png">
							<p>철거/원상복구</p>
						</a>
						<a href="/estimate/estimate_register4.php">
							<img src="../../../img/main/title_slide_img04.png">
							<p>매입+철거(기업전용)</p>
						</a>
					</div>
				</div>
				<div class="title">
					...
					<div class="work_select_area" onclick="work_select_btn()">
						<a href="/estimate/estimate_register1A.php">
							<img src="../../../img/main/title_slide_img01.png">
							<p>
								중고가전/<br>
