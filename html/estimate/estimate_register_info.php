<?php
header('Location: https://repickus.com/estimate/estimate_register.php');
...
<div class="estimate com_pd">
	<div class="container">
		...
		<ul class="tab">
			...
			<li class="col-xs-6">
				<a href="./estimate_register.php">견적신청</a>
			</li>
		</ul>
			...
			<div class="btn_wrap">
				<ul class="row">
					<li class="col-xs-4 col-xs-offset-4 col-md-2 col-md-offset-5" style="margin-left:75px;">
                         <a class="main_bg" href="./estimate_register1B.php" style="width:180px;">가전/가구매입 신청</a>
                         <a class="main_bg" href="./estimate_register2B.php" style="width:180px;">다량매입 신청</a>
                         <a class="main_bg" href="./estimate_register3B.php" style="width:180px;">철거/원상복구 신청</a>
                    ...
                    <!--PC-->
                       <div class="btn_estimate4">
                            <div class="btn_est1"><a href="./estimate_register1B.php">가전/가구매입 신청</a></div>
                            <div class="btn_est1"><a href="./estimate_register2D.php">다량매입 신청</a></div>
                            <div class="btn_est1"><a href="./estimate_register3B.php">철거/원상복구 신청</a></div>
