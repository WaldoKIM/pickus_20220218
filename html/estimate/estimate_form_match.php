...
<div style="z-index: 99999999;" class="modal fade modal_table" id="modal_price_detail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    align-items: center;" class='form_new add_pro'>
									<div style="width:40%;" class='add_name col-xs-5'>
										<input placeholder='품목명' type='text' name='pro_name[]' class="pro_name">
									</div>
									<div style="width:40%; display:flex; align-items:center;" class='add_qty col-xs-5'>
										<input placeholder='가격' type='number' name='pro_price[]' class="pro_price" id="pro_price1">
										<p>원</p>
									</div>

									<a class="add_line" id="add_goods" href="#" style="width:20%;background:#1379cd; text-align:center; border-radius: 5px;white-space: nowrap;">추가</a>
								</div>
					...
					<div class="form-group" style="border:0 !important; margin-bottom:5px; padding-bottom:0;">
						<p class="tit_modal_match" style="margin-bottom:0; font-weight: 700;">참고사항</p>
						<textarea style="height:80px;  border-radius:5px;" name="match_desc"></textarea>
					</div>
					<hr style="border:1px solid #1379cd;">
...
<script type="text/javascript">
	...
	$("#add_goods").click(function() {
		...
		vHtml += "<div style='width:40%;' class='add_name col-xs-5'><input placeholder='품목명'' type='text' name='pro_name[]' class='pro_name'></div>";
		vHtml += "<div style='width:40%; display:flex; align-items:center;' class='add_qty col-xs-5'><input placeholder='가격' type='number' name='pro_price[]' class='pro_price' id='pro_price" + i + " '><p>원</p></div>";
		vHtml += "<a style='width:20%; margin:0; line-height:36px;' class='form_btn delete_item' href='javascript:' >삭제</a>";
		vHtml += "</div>";
