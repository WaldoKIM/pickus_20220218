...
<div class="member com_pd">
	<div class="container">
		<!-- 워크 플로우 부분 -->
		<div class="work_flow">
			<a class="fill_01 work_fill" onclick="flow_select(1)">맞춤 정보</a>
			<p> > </p>
			<a class="fill_02" onclick="flow_select(2)">사진 및 참고사항</a>
			<p> > </p>
			<a class="fill_03" onclick="flow_select(3)">고객 정보</a>
			<p> > </p>
			<a class="fill_04" onclick="flow_select(4)">업체 문의</a>
			<p> > </p>
			<a class="fill_05" onclick="flow_select(5)">견적 신청</a>
		</div>
		<div class="mob_work_flow">
			...
			<a class="fill_04" onclick="flow_select(4)">4.업체 문의</a>
			<a class="fill_05" onclick="flow_select(5)">5.견적 신청</a>
		</div>
		<!-- 워크 플로우 부분 끝 -->
		<div class="request" style="margin-bottom:70px;">
			<div class="form_wrap">
				<form name="frmregister" action="<?php echo G5_URL; ?>/estimate/estimate_register2C_update.php" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="form_section section_view01">
						...
						<div class="form_section_value">
							...
							<div class="form-group">
								<ul>
									<li class="title">
										참고사항
										<p class="text-right red_co">*품목리스트와 수량/년식을 특이사항(문콕,스크래치 등) 함께 작성해 주시면 좀 더 정확한 견적이 가능합니다.</p>
									</li>
									<li>
						...
						<!--================섹션 - 텍스트영역 끝===============-->
						<a href="#" class="next_section_btn" onclick="next_section_btn()">다음</a>
					</div>
					<!--==================================섹션 끝====================================-->
					<!--==================================섹션====================================-->
					<div class="form_section section_view02">
							...
							<div class="form-group">
								<h2 class="txt_title">
									<ul class="row">
										...
										<p style="text-align:right; color:rgb(218, 26, 26); font-size:65%; margin-right:5px;">*물품정보와 실사진이 많을 수록 견적가가 좋아집니다.  </p>
									</ul>
								</h2>
							</div>
						...
						<!--================섹션 - 텍스트영역 끝===============-->
						<a href="#" class="next_section_btn" onclick="prev_section_btn()" style="left:25%">이전</a>
						<a href="#" class="next_section_btn" onclick="next_section_btn()">다음</a>
					</div>
					<!--==================================섹션 끝====================================-->
					<!--==================================섹션====================================-->
