...
<div style="margin-top:65px;" id="margin" class="form_estimate layout_estimate">
	...
	<div class="request">
		<div class="form_wrap layout_wrap">
			<form style="height: 100%;" name="frmregister" action="<?php echo G5_URL; ?>/estimate/estimate_registerSearch_update.php" method="post" enctype="multipart/form-data" autocomplete="off" class="form_order sell_single process_margin layout_form">
				...
				<input type="hidden" name="company" value="pickus">
