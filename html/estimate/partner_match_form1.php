			...
			<div class="view">
				...
				<div class="mob">
					...
					<div class="customer" id="mobileButton">
						<ul class='row'>
							<li class='col-xs-12'>
								<a class='main_bg' href='javascript:doPrice()'>견적 참여하기</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="btn_wrap">
				<ul class="row">
					<li class="col-xs-3 col-xs-offset-9 col-md-1 col-md-offset-11">
						<a class="main_bg" href="./partner_match_list1.php?page=<?php echo $page; ?>">리스트</a>
					</li>
				</ul>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="frmprice" action="<?php echo G5_URL; ?>/estimate/partner_match_form1_update.php" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="form-group">
						<ul class="row">
							...
							<li class="col-xs-6">
								<p>배송/환불/A/S</p>
								<textarea id="delievery" name="delievery"></textarea>
							</li>
						</ul>
					</div>
