		...
		<div class="modal-content">
			...
			<div class="modal-body" style="padding-top:0;">
				<form name="frmpricedetail" action="<?php echo G5_URL; ?>/estimate/estimate_form_match_update.php" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="form-group" style="margin-bottom:5px; padding-bottom:0;">
					...
					<div class="form-group" style="margin-bottom:5px; padding-bottom:5px;">
						...
						<div class="row" id="list_article" style="display:none;">
					...
					<div class="form-group" style="border:0 !important padding-bottom:0; margin-bottom:0;">
						...
						<ul class="row">
							<li class="col-xs-12">
								<p class="tit_modal_match" style="margin-bottom:0; display:inline; margin-right:2vw;">총 금액</p>
